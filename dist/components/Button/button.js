...
export var Button = function (props) {
    var _a;
    var btnType = props.btnType, size = props.size, className = props.className, children = props.children, disabled = props.disabled, href = props.href, restProps = __rest(props, ["btnType", "size", "className", "children", "disabled", "href"]);
